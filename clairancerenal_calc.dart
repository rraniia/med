...
class _ClairanceRenalState extends State<ClairanceRenal> {
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    ...
                    double serumCreatinine =
                        double.tryParse(serumCreatinineController.text) ?? 0;
                    int age = int.tryParse(ageController.text) ?? 0;

                    setState(() {
                      creatinineClearance = calculateCreatinineClearance(
                          weight, serumCreatinine, age, isMale);
                    });
                  },
  ...
  double calculateCreatinineClearance(
      double weight, double serumCreatinine, int age, bool isMale) {
    ...
    double creatinineClearance =
        ((140 - age) * weight * constant) / (serumCreatinine * 72);
